...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="bottom-nav fixed bottom-0 left-0 right-0 z-50 w-full bg-background/95 backdrop-blur-md"
    >
      <div className="bottom-nav__inner mx-auto flex h-12 w-full max-w-md items-end justify-around px-2 pb-1">
