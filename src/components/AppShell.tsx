    ...
    <HomeSessionProvider>
      <VoiceExperienceRoot>
        <div className="app-shell hotel-texture relative mx-auto flex h-[100dvh] w-full max-w-lg flex-col overflow-hidden bg-main">
          <main className="app-scroll no-scrollbar relative z-10 min-h-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-y-none pb-[calc(var(--bottom-nav-height,4.75rem)+var(--safe-bottom,env(safe-area-inset-bottom,0px)))]">
            {children}
          </main>
          <BottomNav />
        </div>
